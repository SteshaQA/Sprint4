...
public class PositiveGenericOrderTest extends BaseTest {
    ...
    public PositiveGenericOrderTest(String nameInput, String surnameInput, String addressInput, String metroStationInput, String numberInput, String dateInput, String rentInput, boolean expected) {
    ...
    public void fillOrderPage() {
        ...
        registerPage.getClickUpOrderButton(); //заказ по верхней кнопке
        //registerPage.getClickDownOrderButton(); //заказ по нижней кнопке
